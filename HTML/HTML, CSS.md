...
создайте html документ и подключите к нему css 

 1 создайте заголовок вашего сайта- назовите его школьной карточкой 
 2 создайте список из пяти ваших лучших друзей класса
 3 создайте таблицу с шапкой - имя, фамилия, лучшее качество характера, любимый цвет, заполните ее про друзей из списка задания 2
 4 раскрасьте любые цвета из задания 3 в соответсвующие цвета 
 5 имена в таблице сделайте ссылками ( по желанию, можете сделать ссылки действующими 
  6 добавьте столбец фото в таблицу и       прикрепите любые картинки